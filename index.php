...
<html lang="en">
	...
	<body class="sfooter">
		<div class="sfooter-content">
			...
			<header>
				<div class="container">
					<h1> Dylan McDonald:~$<span class="subtitle"><em> &emsp;&emsp;Computer Scientist. Cat Lover. Picard Fan.</em></span></h1>
			...
			<section>
				<div class="container">
					...
					<div class="instructions-wrapper">
						...
						<img src="images/captain-janeway.png" alt="captain janeway" height="200px" />
			...
			<!-- PROFESSIONAL SKILLZ -->
			<section class="professional-skillz">
				<div class="container">
